				...
				try {
					if (bufferData.equalsIgnoreCase("winter") || bufferData.equalsIgnoreCase("summer")
						...
						if (bufferData.contains("removeStudentCourse")) {
							...
							stringMessage = ""
									+ exportedObj.addStudentCourse(splitData[1], splitData[2], splitData[3]);
						} else if (bufferData.contains("revertRemove")) {
							// studentid, courseid, semester
							stringMessage = ""
									+ exportedObj.revertRemove(splitData[1], splitData[2]);
						} else if (bufferData.contains("revertAdd")) {
							// studentid, courseid, semester
							stringMessage = ""
									+ exportedObj.revertAdd(splitData[1], splitData[2]);
						}
