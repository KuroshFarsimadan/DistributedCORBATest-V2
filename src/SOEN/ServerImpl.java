...
import Interfaces.ServerInterfacePOA;
...
public class ServerImpl extends ServerInterfacePOA {
	...
	public synchronized String addCourse(StringHolder courseID2, StringHolder semester2) {

		String courseID = courseID2.value;
		String semester = semester2.value;
	 ...
	 * StringHolder)
	 */
	public synchronized String listCourseAvailability(StringHolder semester2) {
	...
	public synchronized String removeCourse(StringHolder courseID2, StringHolder semester2) {
	...
	public synchronized String dropCourse(StringHolder studentID2, StringHolder courseID2) {

		String studentID = studentID2.value;
		String courseID = courseID2.value;
	...
	public synchronized String enrolCourse(StringHolder studentID2, StringHolder courseID2, StringHolder semester2) {
	...
	public synchronized String getClassSchedule(StringHolder studentID2) {
	...
	protected synchronized boolean studentSemesterCourses(String studentID, String semester, String courseID)
		...
		StringHolder studentID2 = new StringHolder(studentID);
		StringHolder semester2 = new StringHolder(semester);
	...
	public synchronized String swapCourse(StringHolder studentID2, StringHolder newCourseID2, StringHolder oldCourse2) {

		String studentID = studentID2.value;
		String newCourseID = newCourseID2.value;
		String oldCourse = oldCourse2.value;
	...
	public synchronized String studentSemesterCourseCount(StringHolder studentID, StringHolder semester) {
		int counter = 0;

		// Each term can have ..* courses
		HashMap<String, HashMap> course = courseRecords.get(semester.value);
		...
		for (Map.Entry me : course.entrySet()) {
			...
			if (student.get(studentID.value) != null) {
				counter += 1;
			}
